...
@implementation LYAudioPlayerHelper
...
- (void)setDelegate:(id<TYHAudioPlayerHelperDelegate>)delegate {
...
+ (id)shareInstance {
    ...
    static LYAudioPlayerHelper *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[LYAudioPlayerHelper alloc] init];
//        [[NSNotificationCenter defaultCenter] addObserver:instance selector:@selector(stopAudio) name:kFSVoiceBubbleShouldStopNotification object:nil];
    });
    return instance;
}
