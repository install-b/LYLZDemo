...
@protocol HPWYSConstraintDelegate;


@interface HPWYSConstraint ()
 ...
 */
@property (nonatomic, weak) id<HPWYSConstraintDelegate> delegate;
...
@interface HPWYSConstraint (Abstract)
...
@protocol HPWYSConstraintDelegate <NSObject>
