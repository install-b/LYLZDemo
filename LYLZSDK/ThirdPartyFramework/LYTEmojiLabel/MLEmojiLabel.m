...
@interface LYTAttributedLabel(MLEmojiLabel)
...
- (void)commonInit {
    ...
    //点击时候的背景色
    [mutableActiveLinkAttributes setValue:(__bridge id)[[UIColor colorWithWhite:0.631 alpha:1.000] CGColor] forKey:(NSString *)kLYTBackgroundFillColorAttributeName];
